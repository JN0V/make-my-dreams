...
export const STALL_SIGNALS = Object.freeze([
  ...
  'heartbeat-stale',
  // SPEC_V02N AC-1: a dirty worktree whose last commit is older than the
  // wip-uncommitted threshold — the WIP-loss-on-kill risk (L-019). Appended
  // (never reordered) so the detector's canonical-order filter is unaffected.
