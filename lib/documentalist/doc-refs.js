...
// patterns below (mmd <subcommand>, ADR-NNN, bare lib/<module>) are conventions,
...
// or is hypothetical/future: "no standalone `mmd judge`", "No `mmd init`", a
// "future `mmd doctor`", "e.g. `mmd context-save`", or a "v0.7.c — … `mmd
...
// for that span. (A cue AFTER the mention — "`mmd teleport` was never built" —
