...
The pure detector is `lib/security/secret-scan.js` (`scanText`); the read-only gate is `bin/security/secret-scan.js`. A dependency/slopsquatting **deps-gate** and an **egress-sandbox** are the next Bundle A bricks. See [ADR-046](./docs/adr/046-secret-scan-gate.md).
...
- **Reflexive slices (release tags)**: 45
- **Tests**: 1902 passing
