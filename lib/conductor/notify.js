...
const EVENTS = Object.freeze(['run_done', 'run_failed', 'context_70', 'handoff']);
...
const PRESENTATION = Object.freeze({
  ...
  // v0.13.a — fired per cooperative handoff: the orchestrator stopped at a phase
  // boundary and MMD is relaunching a fresh successor in resume mode. Reuses the
  // same opt-in/best-effort fan-out (a new signal, not a new transport). ADR-051.
  handoff: { icon: '↪', verb: 'handed off to a fresh successor (cooperative auto-handoff)' },
});
