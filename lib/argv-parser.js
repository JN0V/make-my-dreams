...
const KNOWN_FLAGS = Object.freeze([...ENGINE_FLAGS, ...SESSION_FLAGS, ...MODE_FLAGS, ...VALUE_FLAGS]);
...
export { ENGINE_FLAGS, SESSION_FLAGS, MODE_FLAGS, VALUE_FLAGS, KNOWN_FLAGS, SUBCOMMANDS };
