...
// same machinery serves `mmd document-readme`'s two README blocks (Status +
// Changelog) — it passes its own `mmd:readme:status:*` / `mmd:readme:changelog:*`
// markers — while `mmd handover` keeps calling it with the two-arg form and the
 ...
 *        callers (`mmd handover`) are unchanged.
