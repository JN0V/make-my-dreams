...
// 'mmd:readme:changelog' substring, which also appears in PROSE that merely
// describes the markers (e.g. the README's Usage section says "the
// `mmd:readme:changelog` pair around the Changelog list"). Matching the prose
// mention would misroute the Usage section to CHANGELOG.md (the v0.21-v1 bug).
