...
//
// SRP: pure-ish decision logic about whether `mmdream --here` / `mmdream <dream>`
  ...
  if (reportContent !== null) {
    ...
    return {
      ...
      message:
        ...
        'Review mmd-discovery-report.md, then run `mmdream discover --approve` to mark it validated. ' +
  ...
  if (await looksLikeBrownfield(targetDir)) {
    return {
      ...
      message:
        ...
        'Run `mmdream discover` first, or pass --skip-onboarding to bypass.',
    };
  }
