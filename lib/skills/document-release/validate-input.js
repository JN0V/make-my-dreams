...
/**
 * AC-5: document-release is read-only / advisory — bypass the discovery gate.
 */
export const skipDiscoveryGate = true;

/**
 * Minimal git runner. Same shape as the qa/ship validators.
 *
 * @param {string[]} args
 * @param {string} cwd
 * @returns {Promise<
 ...
 * already spawn with shell=false, we still refuse leading dashes (they'd be
 * interpreted as flags by git) and embedded whitespace.
 *
 * @param {string} ref
 * @returns {boolean}
 */
