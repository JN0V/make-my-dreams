...
deterministic counter mechanism shipped in v0.2.i (\`mmdream document-lessons\`,
...
beyond the explicit \`mmdream document-lessons\` invocation). The full Documentalist
...
- The lesson no longer appears in \`mmdream lessons\` (it is no longer an
