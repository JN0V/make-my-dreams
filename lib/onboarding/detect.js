...
// `mmdream --here` needs to run?". No prompting, no spawning, no mutation — just
...
/**
 * The minimum set `mmdream --here` needs in the target repo. install-mmd.sh
...
/**
 * Probe whether the target repo is ready for `mmdream --here`.
 *
