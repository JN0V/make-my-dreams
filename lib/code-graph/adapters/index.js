...
// (JS first — it is the dogfood stack and the AC-2 regression lock; Python is the
// AC-5 proof of genericity). Adding a language = adding one adapter file + one
// entry here; the core never changes (the whole point of §VIII). Frozen so the
// registry can't be mutated at runtime.
