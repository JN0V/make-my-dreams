...
const javascriptAdapter = {
  ...
  // MMD's JS stratification convention: an `@`-tag in the test title (testing.md
  // §V). This drives the report's "tag them" advice for the JS stack.
  stratumConventionLabel: 'the `@smoke`/`@unit`/`@integration`/`@e2e` tag in the test title (testing.md §V)',
